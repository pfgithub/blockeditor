...
pub const instrs: []const InstrSpec = &[_]InstrSpec{
    ...
    .{ .name = .SLLI, .format = .IShift, .opcode = 0b0010011, .funct3 = 0b001, .funct7 = 0b0000000, .banks = .{ .rs1 = .sint, .rd = .sint } },
    .{ .name = .SRLI, .format = .IShift, .opcode = 0b0010011, .funct3 = 0b101, .funct7 = 0b0000000, .banks = .{ .rs1 = .sint, .rd = .sint } },
