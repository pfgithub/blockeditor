...
pub const instrs: []const InstrSpec = &[_]InstrSpec{
    // Base
    .{ .name = .LUI, .format = .U, .opcode = 0b0110111, .banks = .{ .rd = .int } },
    .{ .name = .AUIPC, .format = .U, .opcode = 0b0010111, .banks = .{ .rd = .int } },
    .{ .name = .JAL, .format = .J, .opcode = 0b1101111, .banks = .{ .rd = .int } },
    .{ .name = .JALR, .format = .I, .opcode = 0b1100111, .funct3 = 0b000, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .BEQ, .format = .B, .opcode = 0b1100011, .funct3 = 0b000, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .BNE, .format = .B, .opcode = 0b1100011, .funct3 = 0b001, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .BLT, .format = .B, .opcode = 0b1100011, .funct3 = 0b100, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .BGE, .format = .B, .opcode = 0b1100011, .funct3 = 0b101, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .BLTU, .format = .B, .opcode = 0b1100011, .funct3 = 0b110, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .BGEU, .format = .B, .opcode = 0b1100011, .funct3 = 0b111, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .LB, .format = .I, .opcode = 0b0000011, .funct3 = 0b000, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .LH, .format = .I, .opcode = 0b0000011, .funct3 = 0b001, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .LW, .format = .I, .opcode = 0b0000011, .funct3 = 0b010, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .LBU, .format = .I, .opcode = 0b0000011, .funct3 = 0b100, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .LHU, .format = .I, .opcode = 0b0000011, .funct3 = 0b101, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .SB, .format = .S, .opcode = 0b0100011, .funct3 = 0b000, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .SH, .format = .S, .opcode = 0b0100011, .funct3 = 0b001, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .SW, .format = .S, .opcode = 0b0100011, .funct3 = 0b010, .banks = .{ .rs1 = .int, .rs2 = .int } },
    .{ .name = .ADDI, .format = .I, .opcode = 0b0010011, .funct3 = 0b000, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .SLTI, .format = .I, .opcode = 0b0010011, .funct3 = 0b010, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .SLTIU, .format = .I, .opcode = 0b0010011, .funct3 = 0b011, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .XORI, .format = .I, .opcode = 0b0010011, .funct3 = 0b100, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .ORI, .format = .I, .opcode = 0b0010011, .funct3 = 0b110, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .ANDI, .format = .I, .opcode = 0b0010011, .funct3 = 0b111, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .SLLI, .format = .IShift, .opcode = 0b0010011, .funct3 = 0b001, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .SRLI, .format = .IShift, .opcode = 0b0010011, .funct3 = 0b101, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .SRAI, .format = .IShift, .opcode = 0b0010011, .funct3 = 0b101, .funct7 = 0b0100000, .banks = .{ .rs1 = .int, .rd = .int } },
    .{ .name = .ADD, .format = .R, .opcode = 0b0110011, .funct3 = 0b000, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .SUB, .format = .R, .opcode = 0b0110011, .funct3 = 0b000, .funct7 = 0b0100000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .SLL, .format = .R, .opcode = 0b0110011, .funct3 = 0b001, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .SLT, .format = .R, .opcode = 0b0110011, .funct3 = 0b010, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .SLTU, .format = .R, .opcode = 0b0110011, .funct3 = 0b011, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .XOR, .format = .R, .opcode = 0b0110011, .funct3 = 0b100, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .SRL, .format = .R, .opcode = 0b0110011, .funct3 = 0b101, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .SRA, .format = .R, .opcode = 0b0110011, .funct3 = 0b101, .funct7 = 0b0100000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .OR, .format = .R, .opcode = 0b0110011, .funct3 = 0b110, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .AND, .format = .R, .opcode = 0b0110011, .funct3 = 0b111, .funct7 = 0b0000000, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    ...
    // M (Multiplication)
    .{ .name = .MUL, .format = .R, .opcode = 0b0110011, .funct3 = 0b000, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .MULH, .format = .R, .opcode = 0b0110011, .funct3 = 0b001, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .MULHSU, .format = .R, .opcode = 0b0110011, .funct3 = 0b010, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .MULHU, .format = .R, .opcode = 0b0110011, .funct3 = 0b011, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .DIV, .format = .R, .opcode = 0b0110011, .funct3 = 0b100, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .DIVU, .format = .R, .opcode = 0b0110011, .funct3 = 0b101, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .REM, .format = .R, .opcode = 0b0110011, .funct3 = 0b110, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
    .{ .name = .REMU, .format = .R, .opcode = 0b0110011, .funct3 = 0b111, .funct7 = 0b0000001, .banks = .{ .rs1 = .int, .rs2 = .int, .rd = .int } },
